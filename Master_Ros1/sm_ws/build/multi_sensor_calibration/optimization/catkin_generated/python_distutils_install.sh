...
echo_and_run cd "/code/sm_ws/src/multi_sensor_calibration/optimization"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/code/sm_ws/src/multi_sensor_calibration/optimization/setup.py" \
     \
    build --build-base "/code/sm_ws/build/multi_sensor_calibration/optimization" \
    install \
    --root="${DESTDIR-/}" \
